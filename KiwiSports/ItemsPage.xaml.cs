...
{
    /// <summary>
    /// A page which acts as the root of the branch structure containing the entry points
    /// to the NZ sport teams. This page is displayed after the splash screen.
    /// </summary>
    public sealed partial class ItemsPage : Page
    {
        ...
        void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            this.Frame.Navigate(typeof(Categories), groupId);
        }
