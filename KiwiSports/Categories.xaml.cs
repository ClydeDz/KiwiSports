...
{
    /// <summary>
    /// A page that displays the categories for each team that the user selects at the beginning
    /// </summary>
    public sealed partial class Categories : Page
    {
        ...
        /// <summary>
        /// Navigates to the appropriate category page once that particular category is clicked from the gridview
        /// </summary>
        /// <param name="sender">
        ...
        private void itemGridView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            var groupTitle = pageTitle.Text;
            switch (itemId)
            {
                case "AB-NEWS":
                case "BC-NEWS":
                    this.Frame.Navigate(typeof(NewsMaster), groupTitle);
                    break;
                case "AB-VIDEOS":
                case "SF-VIDEOS":
                case "BC-VIDEOS":
                    this.Frame.Navigate(typeof(VideoMaster), groupTitle);
                    break;
                case "AB-PHOTOS":
                case "SF-PHOTOS":
                case "BC-PHOTOS":
                    this.Frame.Navigate(typeof(ImageMaster), groupTitle);
                    break;
                case "AB-WIKI":
                case "SF-WIKI":
                case "BC-WIKI":
                    this.Frame.Navigate(typeof(Wiki), groupTitle);
                    break;
                default:
                    break;
            }  
