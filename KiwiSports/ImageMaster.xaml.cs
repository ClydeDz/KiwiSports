...
{
    /// <summary>
    /// A page that displays images from instagram concerning that particular team
    /// </summary>
    public sealed partial class ImageMaster : Page
    {
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            try
            {
                pageTitle.Text = "Images for " + (string)e.NavigationParameter;
                teamName = (string)e.NavigationParameter;
                progressBar.Visibility = Visibility.Visible;
                var sampleDataGroups = await GetInstagramData.GetInstagramImages((string)e.NavigationParameter);
        ...
        /// Title of the error message box
        /// </param>
        private void photos_ItemClick(object sender, ItemClickEventArgs e)
        {
            var groupId = ((GetInstagramData)e.ClickedItem).imageId;
            groupId = groupId + "&" + teamName;
            this.Frame.Navigate(typeof(ImageDetail), groupId);
        }
    }
}
